...
- Fetches `http://localhost:8787/v1/live/:session/:track/media.m3u8`
  ...
  target for end-to-end latency on the local stack is
...
Design-target end-to-end latency: **~2 s** with the byterange LL-HLS path.
The committed OLOS baseline measures 128 ms p50 end-to-end with 100 ms
